...
export default function EditAdForm({
    ...
    // ✅ لو القسم اتغير: صفّر القسم الفرعي
    useEffect(() => {
        const section = watch("section");
        // لو القسم اتغير عن الموجود حاليًا
        if (section && watch("subSection")) {
            // اعمل reset للـ subSection لما تغيّر القسم
            // (لكن بس لو الـ subSection الحالي مش موجود ضمن list الجديدة)
            // أبسط حل: صَفِّره دائمًا عند تغيير القسم
            setValue("subSection", "", { shouldValidate: true });
        }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="image-upload">
                ...
                {errors.images?.message ? (
                    <p className="mt-2 text-sm text-red-500">{String(errors.images.message)}</p>
                ) : null}
            ...
            <div className="form-grid">
                <div className="form-group">
                    ...
                    {errors.section?.message ? (
                        <p className="mt-1 text-sm text-red-500">{String(errors.section.message)}</p>
                    ) : null}
                </div>
                ...
                <div className="form-group">
                    ...
                    <Select
                        value={watch("subSection")}
                        onValueChange={(v) => setValue("subSection", v, { shouldValidate: true })}
                    ...
                    {errors.subSection?.message ? (
                        <p className="mt-1 text-sm text-red-500">{String(errors.subSection.message)}</p>
                    ) : null}
                </div>
            </div>
            ...
            <div className="form-grid">
                ...
                <div className="form-group">
                    ...
                    {errors.model?.message ? (
                        <p className="mt-1 text-sm text-red-500">{String(errors.model.message)}</p>
                    ) : null}
                </div>
                ...
                <div className="form-group">
                    ...
                    {errors.year?.message ? (
                        <p className="mt-1 text-sm text-red-500">{String(errors.year.message)}</p>
                    ) : null}
                </div>
                ...
                <div className="form-group">
                    ...
                    {errors.price?.message ? (
                        <p className="mt-1 text-sm text-red-500">{String(errors.price.message)}</p>
                    ) : null}
                </div>
            </div>
